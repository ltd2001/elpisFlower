...
<head>
    ...
    <title>WS2812B ColorPicker</title>
    <style>
...
<body>
    <div class="container">
        <h1>WS2812B LED Controller</h1>

        <div class="led-section">
            <h2>LED 0</h2> <!-- 修正為LED 0 -->
            <div class="input-group">
                <label for="colorA">ColorPicker:</label>
                <input type="color" id="colorA" value="#000000">
            </div>
            <div class="input-group">
                <label>Manual Input (R,G,B):</label>
            ...
            <div class="input-group">
                <label for="corrAType">Default:</label>
                <select id="corrAType">
            ...
            <div class="current-values">
                <p>DisplayColor (0): <span id="displayColorA">R:0 G:0 B:0</span></p>
                <p>CorrColor (0): <span id="displayCorrA">R:255 G:255 B:255 (Manual)</span></p>
            </div>
        </div>

        <div class="led-section">
            <h2>LED 1</h2> <!-- 修正為LED 1 -->
            <div class="input-group">
                <label for="colorB">ColorPicker:</label>
            ...
            <div class="input-group">
                <label for="corrBType">Default:</label>
                <select id="corrBType">
                    <option value="manual">Manual Input</option>
                    <option value="preset_typical">TypicalLEDStrip</option>
                    <option value="preset_uncorrected">UncorrectedColor</option>
            ...
            <div class="current-values">
                <p>DisplayColor (1): <span id="displayColorB">R:0 G:0 B:0</span></p>
                <p>CorrColor (1): <span id="displayCorrB">R:255 G:255 B:255 (Manual)</span></p>
            </div>
        </div>

        <div class="input-group">
            <label for="globalBrightness">Global Brightness (0-255):</label>
            <input type="number" id="globalBrightness" min="0" max="255" value="50">
        </div>
        <div class="current-values">
            <p>Global Brightness: <span id="displayGlobalBrightness">50</span></p>
        </div>
    ...
    <script>
        ...
        async function fetchCurrentSettings() {
            try {
                ...
                console.error('Parse default setting failed:', error);
            }
        }
